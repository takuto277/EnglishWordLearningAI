...
final class InputWordViewModel: ObservableObject {
    ...
    func getNewWordData() -> NewWordData {
        //TODO: 保持した値を詰め込んで返す
        return NewWordData(englishWord: englishWord, japansesWord: japaneseWord, response: [SentenceResponse(englishSentence: "this is a apple.", japaneseSentence: "これはりんごです。"),
